  ...
  return (
    <AppLayout>
      <div className="max-w-2xl mx-auto px-4 lg:px-0">
        <h1 className="text-2xl font-bold text-gray-800 mb-4 hidden lg:block">ข้อความ</h1>
        ...
        {loading ? (
          ...
          <div className="text-center py-16">
            ...
            <p className="text-gray-400 text-sm mt-1">เริ่มแชทหลังจากยืนยันการจอง</p>
          </div>
        ) : (
              ...
              return (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="font-semibold text-gray-800 truncate">{otherPerson}</p>
                    <p className="text-sm text-gray-400 truncate">{chat.post?.title}</p>
                  </div>
