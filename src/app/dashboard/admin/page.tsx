                    ...
                    <div key={booking.id} className="p-4 hover:bg-gray-50/50 transition">
                      ...
                      <div className="flex gap-2">
                        <button
                          ...
                          className="flex items-center gap-1 bg-success text-white px-3 py-1.5 rounded-lg text-xs font-medium hover:bg-success/90 transition"
                        >
                          <CheckCircle size={14} /> อนุมัติ
                        </button>
                        <button
                          onClick={() => handleOfferAlternative(booking)}
                          className="flex items-center gap-1 bg-purple text-white px-3 py-1.5 rounded-lg text-xs font-medium hover:bg-purple/90 transition"
                        >
                          <AlertCircle size={14} /> เสนอทางเลือก
                        </button>
                        <button
                          onClick={() => handleReject(booking.id)}
                          className="flex items-center gap-1 bg-danger text-white px-3 py-1.5 rounded-lg text-xs font-medium hover:bg-danger/90 transition"
                        >
