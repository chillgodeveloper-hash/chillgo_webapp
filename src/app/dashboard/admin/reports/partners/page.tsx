  ...
  return (
    <AppLayout>
      <div className="max-w-4xl mx-auto px-4 lg:px-0">
        ...
        <div className="bg-white rounded-2xl p-8 border border-primary-dark/20 text-center">
          <Users size={48} className="text-secondary mx-auto mb-4" />
          <h2 className="text-lg font-semibold text-tmain mb-2">รายงานพาร์ทเนอร์</h2>
