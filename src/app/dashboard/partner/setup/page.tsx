...
import { Camera, ImagePlus, X, CheckCircle, ArrowRight, Loader2, LogOut, RefreshCw, ChevronDown, ShoppingBag } from 'lucide-react';
...
export default function PartnerSetupPage() {
  ...
  const handleSwitchPartner = async (targetCategory: 'guide' | 'driver' | 'translator') => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <span className={`text-[10px] font-medium px-2 py-0.5 rounded-full ${
                          isCurrent ? 'bg-primary/30 text-tmain' :
                          registered ? 'bg-success/15 text-success' : 'bg-warning/15 text-warning'
                        }`}>
