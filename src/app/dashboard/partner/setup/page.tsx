    ...
    <div className="min-h-screen bg-primary-light flex items-center justify-center p-4">
      <div className="max-w-lg w-full">
        <div className="flex items-center justify-between mb-4">
          <button onClick={() => router.push('/feed')} className="flex items-center gap-1.5 text-sm text-tmuted hover:bg-white/50 transition px-3 py-2 rounded-xl"><ArrowLeft size={16} /> กลับหน้าหลัก</button>
